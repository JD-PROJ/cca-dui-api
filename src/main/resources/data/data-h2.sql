...
insert into CAL_SCHEDULE_MEM(MEM_NO, SCHEDULE_NO, NON_AVAILABLE_TIME, UPDATE_NO, UPDATE_DATE, CREATE_NO, CREATE_DATE) values (1000, 1, null, 1000, sysdate(), 1000, sysdate());
